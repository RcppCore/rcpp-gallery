...
Finally, let's compare the speed gain result. The test data is based on a return matrix of 30 securities with 2500 data poitns. It can be seen that the OpenMP version of the calculation is __more than 150x__ faster than the R version. 
