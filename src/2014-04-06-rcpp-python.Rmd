...
This post relied on two C++ libraries which ease the work greatly: Rcpp for R, and Boost.Python for
Python.  A similar approach might be used to integrate R with other
scripting language such as Javascript using nodejs and the  
