...
With Rcpp modules (Eddelbuettel and François, 2017) it is easy to expose
...
attributes (Allaire et al, 2017) using Rcpp attributes
...
loaded as the required functionality that transforms the class between a
\code{SEXP} and a regular \proglang{C++} object can't be loaded. The solution is
