...
```{r long_computation_omp2, engine="Rcpp", eval=FALSE}
#ifdef _OPENMP
#include <omp.h>
#endif
// [[Rcpp::plugins(openmp)]]
...
```{r long_computation_omp2_call, eval=FALSE}
...
```{r final_example, eval=FALSE, engine="Rcpp"}
#ifdef _OPENMP
#include <omp.h>
#endif
// [[Rcpp::plugins(openmp)]]
...
```{r final_example_call, eval=FALSE}
