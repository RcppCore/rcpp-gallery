...
license: GPL (>= 2)
tags: Rcpp benchmarking RcppClock
summary: Rcpp benchmarking with a simple C++ tick-tock clock and seamless integration
...
* On the C++ side, RcppClock wraps `std::chrono::high_resolution_clock` to time chunks of code, and exports the results to an R object in the global environment.
...
Note: RcppClock is not compatible with OpenMP parallelization, and does not accurately measure processes taking less than ~1 microsecond.
