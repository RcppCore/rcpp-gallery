...
SimpleProgressBar.hpp. It's OK for most purposes to give you an idea how much work 
...
called. In comparison to the example of the default progress bar above, I moved the 
...
It only works for Unix-like systems -- a less cool version for windows can be found [here]().
