...
A less cool version of an ETA progress bar for windows can be found [here](). 
...
seconds to a humanly readable string. The basic algorithm is based on an example from 
