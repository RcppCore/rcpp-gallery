...
license: GPL (>= 2)
tags: openmp modelling rfinance correlation
...
stopifnot(identical(gerber.correlation(HIST_RETURN, LOOKBACK), GERBER_CORRELATION_PARALLEL_OMP(HIST_RETURN, LOOKBACK)))
